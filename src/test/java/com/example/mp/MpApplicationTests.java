...
//        Assert.assertEquals(5, userList.size());
    ...
    public void testCrud() {
        userService.save(new User("xzx", 18, "123@321.com"));
        List<User> list = new ArrayList<>();
        list.add(new User("xzx", 19, "123@321.com"));
        list.add(new User("xzx", 20, "123@321.com"));
        userService.saveBatch(list);
        list.add(new User("xzx", 21, "123@321.com"));
